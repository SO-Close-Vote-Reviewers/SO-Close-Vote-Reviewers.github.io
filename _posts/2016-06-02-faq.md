...
The Smoke Detector (aka Smokey) is a chat-bot operated by the [Charcoal team](http://stackoverflow.com/teams/52/charcoal) and its purpose is to find spam, abusive and low-quality posts. In the SOCVR room only Stack Overflow posts are reported. You can find detailed info about Smokey and how you can interact with it [here](https://github.com/Charcoal-SE/SmokeDetector/wiki).

To request SD privileges from the SOCVR room ping any of the Room Owners. Do know we expect you to have lurked in the room for a while so you understand its  capabilities and how to respond to reports. We don't want to feed wrong information into Smokey or flag reported posts incorrectly.

## Who is Queen?

A popular  70's pop-group which had a few hits, some world-wide. It also could be a BOT for reporting possible duplicates to holders of a Goldbadge in a particular tag.
...
**Queen**  
Is a bit for reporting duplicates to Gold Hammers so these get closed effectively. Her hive is in the [SOCVFinder](http://chat.stackoverflow.com/rooms/111347/socvfinder)
