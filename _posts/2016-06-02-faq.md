...
23. Do not post multiple successive moderator requests for posts of the same user. 
    It will be considered as targetting a user which is explicitly forbidden.
